...
public class APIRESTApiRestClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "APIRESTApiRestClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:APIRESTApiRestClient = {
        ...
        return APIRESTApiRestClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = APIRESTApiRestClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `APIRESTApiRestClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> APIRESTApiRestClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         APIRESTApiRestClient.registerClient(withConfiguration: configuration, forKey: "USWest2APIRESTApiRestClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = APIRESTApiRestClient.client(forKey: "USWest2APIRESTApiRestClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(APIRESTApiRestClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> APIRESTApiRestClient {
		objc_sync_enter(self)
		if let client: APIRESTApiRestClient = _serviceClients.object(forKey: key) as? APIRESTApiRestClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			APIRESTApiRestClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! APIRESTApiRestClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://11rmsdmvw7.execute-api.us-east-1.amazonaws.com/dev"
