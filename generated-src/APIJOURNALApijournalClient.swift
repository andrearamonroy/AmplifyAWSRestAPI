...
public class APIJOURNALApijournalClient: AWSAPIGatewayClient {

	static let AWSInfoClientKey = "APIJOURNALApijournalClient"

	private static let _serviceClients = AWSSynchronizedMutableDictionary()
	private static let _defaultClient:APIJOURNALApijournalClient = {
        ...
        return APIJOURNALApijournalClient(configuration: serviceConfiguration!)
	}()
	...
	/**
	 ...
	 Then call the following to get the default service client:
	     ...
	     let serviceClient = APIJOURNALApijournalClient.default()

     Alternatively, this configuration could also be set in the `info.plist` file of your app under `AWS` dictionary with a configuration dictionary by name `APIJOURNALApijournalClient`.
	
	 @return The default service client.
	 */ 
	 
	public class func `default`() -> APIJOURNALApijournalClient{
	...
	/**
	 ...
	 If you want to enable AWS Signature, set the default service configuration in `func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?)`
	     ...
	     func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
	         ...
	         APIJOURNALApijournalClient.registerClient(withConfiguration: configuration, forKey: "USWest2APIJOURNALApijournalClient")
	 ...
	 Then call the following to get the service client:
	     ...
	     let serviceClient = APIJOURNALApijournalClient.client(forKey: "USWest2APIJOURNALApijournalClient")
	...
	public class func registerClient(withConfiguration configuration: AWSServiceConfiguration, forKey key: String){
		_serviceClients.setObject(APIJOURNALApijournalClient(configuration: configuration), forKey: key  as NSString);
	}
	 ...
	 */
	public class func client(forKey key: String) -> APIJOURNALApijournalClient {
		objc_sync_enter(self)
		if let client: APIJOURNALApijournalClient = _serviceClients.object(forKey: key) as? APIJOURNALApijournalClient {
			objc_sync_exit(self)
		    return client
		}
		...
		if let serviceInfo = serviceInfo {
			...
			APIJOURNALApijournalClient.registerClient(withConfiguration: serviceConfiguration!, forKey: key)
		}
		objc_sync_exit(self)
		return _serviceClients.object(forKey: key) as! APIJOURNALApijournalClient;
	}
	...
	init(configuration: AWSServiceConfiguration) {
	    ...
	    var URLString: String = "https://968w35va79.execute-api.us-east-1.amazonaws.com/dev"
    ...
    /*
     ...
     return type: 
     */
    public func itemsProxyOptions(proxy: String) -> AWSTask<AnyObject> {
	    let headerParameters = [
                   "Content-Type": "application/json",
                   "Accept": "application/json",
